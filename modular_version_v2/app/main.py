...
# We import our new, separated classes
...
if __name__ == "__main__":
    ...
    # 5. Trigger the initial data loading process. This will show the file dialog.
    # We use a QTimer to ensure the main window is fully shown before the blocking
    # file dialog appears. This provides a better user experience.
